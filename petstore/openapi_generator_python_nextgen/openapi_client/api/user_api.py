...
class UserApi(object):
    ...
    @validate_arguments
    def login_user(self, username : Annotated[constr(strict=True), Field(..., description="The user name for login")], password : Annotated[StrictStr, Field(..., description="The password for login in clear text")], **kwargs) -> str:  # noqa: E501
