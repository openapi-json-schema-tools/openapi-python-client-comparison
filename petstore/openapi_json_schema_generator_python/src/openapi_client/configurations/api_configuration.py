...
from openapi_client.servers import server_0
...
SecurityIndexInfo = typing_extensions.TypedDict(
    ...
    {
        'security': int,
        "paths//pet/post/security": typing_extensions.Literal[0],
        "paths//pet/put/security": typing_extensions.Literal[0],
        "paths//pet/findByStatus/get/security": typing_extensions.Literal[0],
        "paths//pet/findByTags/get/security": typing_extensions.Literal[0],
        "paths//pet/{petId}/delete/security": typing_extensions.Literal[0],
        "paths//pet/{petId}/get/security": typing_extensions.Literal[0],
        "paths//pet/{petId}/post/security": typing_extensions.Literal[0],
        ...
        "paths//user/post/security": typing_extensions.Literal[0],
        "paths//user/createWithArray/post/security": typing_extensions.Literal[0],
        "paths//user/createWithList/post/security": typing_extensions.Literal[0],
        "paths//user/logout/get/security": typing_extensions.Literal[0],
        "paths//user/{username}/delete/security": typing_extensions.Literal[0],
        "paths//user/{username}/put/security": typing_extensions.Literal[0],
    },
    total=False
)
